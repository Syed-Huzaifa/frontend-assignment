        ...
        <v-app style="width: 100%">
            ...
            >
                <v-list style="display: flex; flex-direction: column;">
                    <v-btn variant="text" @click="router.push({ path: '/todos' }), drawer = false" class="mb-4">View All</v-btn>
                    <v-btn variant="text" @click="router.push({ path: '/todos/create' }), drawer = false">Create Todo</v-btn>
                </v-list>
            </v-navigation-drawer>
        </v-app>
    </div>
